...
var inputPaths = {
	config: __dirname + '/../json_input/project/config.json',
	architecture: __dirname + '/../json_input/project/architecture.json',
	furniture: __dirname + '/../json_input/project/furnitures.json'
};
